...
public interface UserTokenDao {
    ...
    /**
     * Called to check the availability of tokens when checking if user is authorized or not
     * Also called when use of tokens is needed for this user for spreadsheet related operations
    ...
    /**
     * Called to store or update tokens of user
